...
class BeverageAdapter : RecyclerView.Adapter<BeverageAdapter.ListViewHolder>() {

    private var listData = ArrayList<Beverage>()
    var onItemClick: ((Beverage) -> Unit)? = null

    fun setData(newListData: List<Beverage>?) {
